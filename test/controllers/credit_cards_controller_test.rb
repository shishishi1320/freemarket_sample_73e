...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { card_id: @credit_card.card_id, customer_id: @credit_card.customer_id, user_id_id: @credit_card.user_id_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { card_id: @credit_card.card_id, customer_id: @credit_card.customer_id, user_id_id: @credit_card.user_id_id } }
